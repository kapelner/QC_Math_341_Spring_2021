...
\title{MATH 341 / 650.3 Spring \the\year~Homework \#3 INCOMPLETE}
...
\intermediatesubproblem{Assume the dataset $x = <1,1,1,1,1,1>$, $n=6$ and Haldane's prior. Is it possible to compute a point estimate? Is it possible to compute CR's? Is it possible to compute Bayesian p-vals when testing hypotheses?} \spc{1}
