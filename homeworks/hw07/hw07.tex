...
\title{MATH 341 / 650.3 Spring \the\year~Homework \#7}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{NOT DUE \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, read about the normal-inverse-gamma conjugate model with Jeffrey's priors, marginal posteriors in the normal-inverse-gamma conjugate model with Jeffrey's priors, how a non-conjugate model can break our inferential paradigm, how this can be solved with grid sampling, disadvantages to grid sampling, the systematic sweep Gibbs sampler, and Bayesian inference in the change point model.
